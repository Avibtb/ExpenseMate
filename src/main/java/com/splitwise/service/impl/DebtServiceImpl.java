...
public class DebtServiceImpl implements DebtService {
    ...
    public void addDebts(Expense expense) {
        ...
        for (Split split : splits) {
            ...
            if (!debtRepository.existsByPayerAndPayee(payer, payee) && !debtRepository.existsByPayerAndPayee(payer, payee)) {
    ...
    @Override
    public boolean existsByPayerAndPayee(Users payer, Users payee) {
        return debtRepository.existsByPayerAndPayee(payer, payee);
    }

    @Override
    public Debt findByPayerAndPayee(Users payer, Users payee) {
